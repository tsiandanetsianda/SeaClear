...
export const Footer = ({
  ...
  return (
    <div className={`footer breakpoint-51-${breakpoint} ${className}`}>
      ...
      <div className="credits">
        ...
        <div className="row-2">
          <div className="element-relume-all">
            {breakpoint === "desktop" && <p className="text-wrapper-11">{text5}</p>}

            {breakpoint === "mobile" && (
              <>
                <div className="text-wrapper-8">Privacy Policy</div>
                <div className="text-wrapper-9">{text6}</div>
                <div className="text-wrapper-9">{text7}</div>
              </>
            )}
          </div>
          <div className="footer-links">
            {breakpoint === "desktop" && (
              <>
                <div className="text-wrapper-8">Privacy Policy</div>
                <div className="text-wrapper-8">{text6}</div>
                <div className="text-wrapper-8">{text7}</div>
              </>
            )}

            {breakpoint === "mobile" && <p className="text-wrapper-11">{text5}</p>}
          </div>
        </div>
      </div>
    </div>
