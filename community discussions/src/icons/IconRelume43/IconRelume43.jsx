...
export const IconRelume43 = ({ color = "black", className }) => {
  return (
    <svg
      className={`icon-relume-43 ${className}`}
      fill="none"
      height="48"
      viewBox="0 0 49 48"
      width="49"
